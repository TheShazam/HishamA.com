...
function init() {
  ...
  geometry = new THREE.CircleGeometry( 2 );
...
// Google Map Options
function initMap() {
	var addressString = 'Downtown Dallas, Dallas, TX'
	var myLatlng = new google.maps.LatLng(32.780270, -96.793830); // <- Your latitude and longitude
	var styles = [
		{
			"stylers": [
				{
